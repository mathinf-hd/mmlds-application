...
<div class="flex gap-4 flex-col">
	...
	<div class="flex gap-8 items-center">
		<div class="w-40"><P class="font-bold">Standard period of your study program in months (not the time it took you to finish your studies)</P></div>
		<PositiveNumberInput bind:value={$data["extentDetails"]["duration"]} class="w-20 text-2xs text-center" />
	</div>
	<div class="flex gap-8 items-center">
		<div class="w-40"><P class="font-bold">Total number of credit points required in your study program (no grades, no grade point averages etc.)</P></div>
