...
<P> Please check the box <Checkbox bind:checked={$data.osproject.check} class="m-auto"/>, if you actively contributed to an open source project. To declare these skills, add for each respective open source project the name of the project, the link to a public repository and your identifier.
</P> 
